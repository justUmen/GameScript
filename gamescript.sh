...
function enter(){
  ...
  case $2 in
    ...
    1) echo "" ;&
  	...
  	3) show_menu "$1" "$1 : $CHAPTER 1" "$1 : $CHAPTER 2" "$1 : $CHAPTER 3" "$1 : $CHAPTER 4" "$1 : $CHAPTER 5" "$1 : $CHAPTER 6" "$1 : $CHAPTER 7" "$1 : $CHAPTER 8" "$1 : $CHAPTER 9" "$1 : $CHAPTER 10 [beta, no sound]" "$1 : $CHAPTER 11 [alpha, no sound, no quiz]";; #"$1 : chapitre 8"
