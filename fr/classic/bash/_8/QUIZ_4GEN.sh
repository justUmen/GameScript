...
function start_quiz(){
  ...
  answer_text_fr "En redirigeant vers l'entrée standard de grep, comment afficher toutes les lignes du fichier 'grep' qui contiennent le mot 'cat' ?" "cat grep|grep cat"
